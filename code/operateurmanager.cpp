...
operateurManager::operateurManager():ops(new operateur*[nb]){
    ...
    //! \brief Opérateur de création de complexe
    dollar* complexe= new dollar();
    //! \brief Opérateur pour obtenir le negatif
    neg* negatif= new neg();
    //! \brief Opérateur pour obtenir le resultat du test ==
    opegal* egalite= new opegal();
    //! \brief Opérateur pour obtenir le resultat du test !=
    opdiff* difference= new opdiff();
    //! \brief Opérateur pour obtenir resultat du test <=
