/**
\file operateur_pile.h
\date 03/06/2016
\author LoÃ¯c Lerat, AndrÃ©a Vibert, ThÃ©o Hordequin
\version 1.0
\brief  Classe operateur_pile

Description de la classe operateur_pile

**/



#ifndef OPERATEUR_PILE_H
#define OPERATEUR_PILE_H
#include "operateur.h"
...
public:
    ...
    //! \param  f QString
    //! \param  a int
    operateur_pile(int a, QString s)
        : operateur(a, s)
    {
    }
